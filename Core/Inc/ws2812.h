...
#define TIMx_CC1_DMA_REQUEST             	DMA_REQUEST_7
...
#define LED_NUMBER							(241)			// how many LEDs the MCU should control?
...
void dataCompleteTransfert(DMA_HandleTypeDef *DmaHandle);
